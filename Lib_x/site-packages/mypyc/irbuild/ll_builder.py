...
class LowLevelIRBuilder:
    ...
    def literal_static_name(self, value: Union[int, float, complex, str, bytes]) -> str:
        return STATIC_PREFIX + self.mapper.literal_static_name(
    ...
    def new_list_op(self, values: List[Value], line: int) -> Value:
        ...
        ob_item_base = self.add(
            LoadMem(pointer_rprimitive, ob_item_ptr, result_list, line)
        )
        for i in range(len(values)):
            ...
            self.add(
                SetMem(object_rprimitive, item_address, args[i], result_list, line)
            )
        return result_list
